        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Helping you navigate your professional journey with confidence and clarity.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/career-paths" className="text-sm text-muted-foreground hover:text-foreground">
                  Career Paths
                </a>
              </li>
              <li>
                <a href="/assessments" className="text-sm text-muted-foreground hover:text-foreground">
                  Skill Assessments
                </a>
              </li>
              <li>
